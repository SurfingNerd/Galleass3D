...
namespace Galleass3D
{
    ...
    #pragma warning restore CS4014
        ...
        {
            TransactionDetailsHolder detailHolder = this.gameObject.GetComponentInChildren<TransactionDetailsHolder>(); 
            ...
            {
                Debug.LogWarning("Unable to show Transaction details: No TransactionDetailsHolder could be found as child.");
            }
        }
