...
namespace Galleass3D.Contracts.StandardTile
{
    public partial class StandardTileService
    {
        ...
        public StandardTileService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
