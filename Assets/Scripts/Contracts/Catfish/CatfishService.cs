...
using Galleass3D.Contracts.Catfish.ContractDefinition;

namespace Galleass3D.Contracts.Catfish
{
    public partial class CatfishService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CatfishDeployment catfishDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CatfishDeployment>().SendRequestAndWaitForReceiptAsync(catfishDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CatfishDeployment catfishDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CatfishDeployment>().SendRequestAsync(catfishDeployment);
        }

        public static async Task<CatfishService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CatfishDeployment catfishDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, catfishDeployment, cancellationTokenSource);
            return new CatfishService(web3, receipt.ContractAddress);
        }
        ...
        public CatfishService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
