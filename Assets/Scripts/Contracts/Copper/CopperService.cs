...
using Galleass3D.Contracts.Copper.ContractDefinition;

namespace Galleass3D.Contracts.Copper
{
    public partial class CopperService
    {
        ...
        public CopperService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
