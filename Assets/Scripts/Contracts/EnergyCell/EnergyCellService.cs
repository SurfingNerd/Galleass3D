...
using Galleass3D.Contracts.EnergyCell.ContractDefinition;

namespace Galleass3D.Contracts.EnergyCell
{
    public partial class EnergyCellService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, EnergyCellDeployment energyCellDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<EnergyCellDeployment>().SendRequestAndWaitForReceiptAsync(energyCellDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, EnergyCellDeployment energyCellDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<EnergyCellDeployment>().SendRequestAsync(energyCellDeployment);
        }

        public static async Task<EnergyCellService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, EnergyCellDeployment energyCellDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, energyCellDeployment, cancellationTokenSource);
            return new EnergyCellService(web3, receipt.ContractAddress);
        }
        ...
        public EnergyCellService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
