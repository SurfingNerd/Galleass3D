...
async function deployEip1820(payingAccount) {
  ...
  const gotCode = await web3.eth.getCode('0x1820a4B7618BdE71Dce8cdc73aAB6C95905faD24');

  if (gotCode === '0x') {
    // contract does not exist, deploy new.
    console.log('transfering funds for single use account');
    await web3.eth.sendTransaction({ from: payingAccount,  to: '0xa990077c3205cbDf861e17Fa532eeB069cE9fF96', value: web3.utils.toHex('80000000000000000')})
    console.log('creating introspection contract');
    ...
    console.log('introspection got deployed: ', introspectionResult.contractAddress);
  } else {
